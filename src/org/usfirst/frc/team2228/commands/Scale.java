...
public class Scale extends Command {
	Elevator elevator;
    public Scale(Elevator _elevator) {
    	super(5.0);
    	elevator = _elevator;
    ...
    protected void execute() {
    	elevator.elevatorSet(Dimensions.SCALE_HIGHEST_POSITION, 0.3);
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
        return !elevator.elevatorSet(Dimensions.SCALE_HIGHEST_POSITION, 0.3);
    }
