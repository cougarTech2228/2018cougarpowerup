...
public class SRXDriveBaseCfg {
		...
		public static double kRightInchesPerCount = 0.0361; //old 0.0179
		public static double kRightEncoderCountsPerIn = 27.855; //old 55.586
		
		// kMeasuredLftWheelCircum / kCountsPerRevolution; 1/kLeftInchesPerCount
		public static double kLeftInchesPerCount = 0.0359; //old 0.01799
		public static double kLeftEncoderCountsPerIn = 27.701; //old 55.586
		...
		public static double kDriveStraightCorrection = 1.058; // Hard floor correction 0.87;
