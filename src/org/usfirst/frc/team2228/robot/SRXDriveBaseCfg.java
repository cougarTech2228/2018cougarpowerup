...
public class SRXDriveBaseCfg {
		...
		// kCountsPerRevolution = quadrature(4) * kDriveEncoderCyclesPerRev = 4*130.9
		...
		public static double kdriveRightMstrFeedForwardGain = 2; //2
		...
		public static double kdriveLeftMstrFeedForwardGain = 2; //2
